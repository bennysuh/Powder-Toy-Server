...
--
-- Host: localhost
-- Generation Time: Oct 11, 2011 at 04:48 PM
...
(NULL, 'tpt_server', 'sessions', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'tpt_server', 'sessions', 'sessionid', 2, NULL, 'NO', 'varchar', 31, 93, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(31)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'tpt_server', 'sessions', 'userid', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'tpt_server', 'sessions', 'expiredate', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'tpt_server', 'users', 'ID', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'tpt_server', 'users', 'name', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'tpt_server', 'users', 'profile', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'tpt_server', 'users', 'passhash', 4, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', 'UNI', '', 'select,insert,update,references', ''),
(NULL, 'tpt_server', 'users', 'mode', 5, NULL, 'NO', 'varchar', 3, 9, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(3)', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_KEY', '0'),
('HANDLER_READ_NEXT', '993'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '5566'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
...
('QCACHE_FREE_MEMORY', '16763280'),
('QCACHE_HITS', '0'),
('QCACHE_INSERTS', '4'),
('QCACHE_LOWMEM_PRUNES', '0'),
('QCACHE_NOT_CACHED', '137'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '1159'),
('UPTIME_SINCE_FLUSH_STATUS', '1159');
...
('SLOW_QUERY_LOG_FILE', '/var/lib/mysql/lieuwe-desktop-slow.log'),
('HAVE_SSL', 'DISABLED'),
('PROFILING', 'OFF'),
...
('GENERAL_LOG_FILE', '/var/lib/mysql/lieuwe-desktop.log'),
('SKIP_NAME_RESOLVE', 'OFF'),
('SSL_CERT', ''),
('SQL_BIG_TABLES', 'OFF'),
('AUTO_INCREMENT_INCREMENT', '1'),
('PID_FILE', '/var/lib/mysql/lieuwe-desktop.pid'),
('TMPDIR', '/tmp'),
...
(NULL, 'tpt_server', 'PRIMARY', NULL, 'tpt_server', 'sessions', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'tpt_server', 'sessionid', NULL, 'tpt_server', 'sessions', 'sessionid', 1, NULL, NULL, NULL, NULL),
(NULL, 'tpt_server', 'sessionid', NULL, 'tpt_server', 'sessions', 'userid', 2, NULL, NULL, NULL, NULL),
(NULL, 'tpt_server', 'PRIMARY', NULL, 'tpt_server', 'users', 'ID', 1, NULL, NULL, NULL, NULL),
(NULL, 'tpt_server', 'name', NULL, 'tpt_server', 'users', 'name', 1, NULL, NULL, NULL, NULL),
(NULL, 'tpt_server', 'passhash', NULL, 'tpt_server', 'users', 'passhash', 1, NULL, NULL, NULL, NULL);
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-10-11 14:48:53', '2011-10-11 14:48:53', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-10-11 14:48:53', '2011-10-11 14:48:53', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-10-11 14:48:53', '2011-10-11 14:48:53', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-10-11 14:48:53', '2011-10-11 14:48:53', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-10-11 14:48:53', '2011-10-11 14:48:53', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-10-11 14:48:53', '2011-10-11 14:48:53', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-10-11 14:48:53', '2011-10-11 14:48:53', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-10-11 14:48:53', '2011-10-11 14:48:53', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2011-10-09 18:46:55', '2011-10-09 18:46:55', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 123848989752688639, 2048, 0, '2011-10-09 18:46:59', '2011-10-09 18:46:59', '2011-10-09 18:46:59', NULL, '', '', NULL),
(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-10-09 18:46:59', '2011-10-09 18:46:59', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2011-10-09 18:46:57', '2011-10-09 18:46:57', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2011-10-09 18:46:24', '2011-10-09 18:46:25', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 452, 197, 89044, 55450570411999231, 16384, 0, '2011-10-09 18:46:24', '2011-10-09 18:46:25', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2011-10-09 18:46:59', '2011-10-09 18:46:59', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-10-09 18:46:25', '2011-10-09 18:46:25', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2011-10-09 18:46:24', '2011-10-09 18:46:24', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-10-09 18:46:58', '2011-10-09 18:46:58', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2011-10-09 18:46:58', '2011-10-09 18:46:58', '2011-10-09 18:46:58', 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2011-10-09 18:46:24', '2011-10-09 18:46:24', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2011-10-09 18:46:55', '2011-10-09 18:46:55', '2011-10-09 18:46:55', 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2011-10-09 18:46:25', '2011-10-09 18:46:25', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2011-10-09 18:46:25', '2011-10-09 18:46:25', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2011-10-09 18:46:25', '2011-10-09 18:46:25', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2011-10-09 18:46:25', '2011-10-09 18:46:25', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2011-10-09 18:46:25', '2011-10-09 18:46:25', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 96, 384, 281474976710655, 2048, 0, NULL, '2011-10-09 18:46:59', '2011-10-09 18:46:59', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'tpt_server', 'sessions', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2011-10-10 14:03:16', '2011-10-10 14:03:16', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'tpt_server', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 52, 52, 281474976710655, 4096, 0, 2, '2011-10-10 14:04:15', '2011-10-10 14:04:15', NULL, 'latin1_swedish_ci', NULL, '', '');
...
(NULL, 'tpt_server', 'PRIMARY', 'tpt_server', 'sessions', 'PRIMARY KEY'),
(NULL, 'tpt_server', 'sessionid', 'tpt_server', 'sessions', 'UNIQUE'),
(NULL, 'tpt_server', 'PRIMARY', 'tpt_server', 'users', 'PRIMARY KEY'),
(NULL, 'tpt_server', 'name', 'tpt_server', 'users', 'UNIQUE'),
(NULL, 'tpt_server', 'passhash', 'tpt_server', 'users', 'UNIQUE');
...
('''root''@''lieuwe-desktop''', NULL, 'SELECT', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'INSERT', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'UPDATE', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'DELETE', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'CREATE', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'DROP', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'RELOAD', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'SHUTDOWN', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'PROCESS', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'FILE', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'REFERENCES', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'INDEX', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'ALTER', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'SHOW DATABASES', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'SUPER', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'CREATE TEMPORARY TABLES', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'LOCK TABLES', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'EXECUTE', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'REPLICATION SLAVE', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'REPLICATION CLIENT', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'CREATE VIEW', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'SHOW VIEW', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'CREATE ROUTINE', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'ALTER ROUTINE', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'CREATE USER', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'EVENT', 'YES'),
('''root''@''lieuwe-desktop''', NULL, 'TRIGGER', 'YES'),
...
('lieuwe-desktop', 'root', '*81F5E21E35407D884A6CD4A731AEBFB6AF209E1B', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('127.0.0.1', 'root', '*81F5E21E35407D884A6CD4A731AEBFB6AF209E1B', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('localhost', 'debian-sys-maint', '*579727B26E66D997FFE96B27980EF6DD39C836F2', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0);
--
-- Database: `tpt_server`
--
CREATE DATABASE `tpt_server` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `tpt_server`;
...
INSERT INTO `users` (`ID`, `name`, `profile`, `passhash`, `mode`) VALUES
(1, 'doxin', NULL, '2bf9b8c207ed95520e69887b7bce8a99', 'MOD');
